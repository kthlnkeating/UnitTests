ZZRGUSD1 ;Unit Tests - Clinic API; 1/21/2013
...
LSTCLNS ;
 ...
 ;
CLNRGHT ;
 S RTN="CLNRGHT^SDMAPI1(.RETURN,CLN)" D EXSTCLN^ZZRGUSD2(RTN)
...
GETSCAP ;
 ...
 S RTN="GETSCAP^SDMAPI1(.RETURN,CLN,PAT,SD)" D EXSTPAT^ZZRGUSD2(RTN),EXSTCLN^ZZRGUSD2(RTN)
...
GETELIG ;
 ...
 Q
GETPEND ;
 S RTN="GETPEND^SDMAPI1(.RETURN,PAT,DT)" D EXSTPAT^ZZRGUSD2(RTN)
 ...
 Q
GETAPTS ;
 S RTN="GETAPTS^SDMAPI1(.RETURN,PAT,SD)" D EXSTPAT^ZZRGUSD2(RTN)
...
LSTCAPTS ;
 ...
 S RTN="LSTCAPTS^SDMAPI1(.RETURN,CLN,.SDBEG,.SDEND,)" D EXSTCLN^ZZRGUSD2(RTN)
...
LSTPAPTS ;
 N SDT
 S SDT=DT+1_".08",SDT=SDT_U_$$FMTE^XLFDT(SDT)
 S RTN="LSTPAPTS^SDMAPI1(.RETURN,PAT,.SDBEG,.SDEND,)" D EXSTPAT^ZZRGUSD2(RTN)
...
LSTCRSNS ;
 ...
 Q
GETCSC ;
 S RTN="GETCSC^SDMAPI1(.RETURN,CLN)" D EXSTCLN^ZZRGUSD2(RTN)
