ZZRGUSD1 ;Unit Tests - Clinic API; 05/28/2012  11:46 AM
...
CLNCK ;
 ...
 ;
 K RETURN S STOP=$O(^DIC(40.7,0)),$P(^SC(SC,0),U,7)=STOP
...
GETCLN ;
 ...
 D CHKEQ^XTMUNIT(RETURN("STOP CODE NUMBER"),"1^EMERGENCY UNIT")
 ...
 D CHKEQ^XTMUNIT(RETURN("MAX # DAYS FOR FUTURE BOOKING"),"")
