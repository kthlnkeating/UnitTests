ZZRGUT ;RGI/CBR - Unit Tests - Problem List API ;4/8/13
...
GETPLIST ;
 N RETURN
 S %=$$GETPLIST^GMPLAPI4(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPDFN.")
 S %=$$GETPLIST^GMPLAPI4(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPDFN not numeric.")
 S %=$$GETPLIST^GMPLAPI4(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PATNFND",$P($G(RETURN(0)),U)," - GMPDFN not found.")
 S %=$$GETPLIST^GMPLAPI4(.RETURN,GMPDFN,"Q")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Invalid GMPSTAT value.")
...
API2NEW ;
 ...
 ;
API2DEL ;
 N OK,NOTENMBR,RETURN,%
 K GMPERR
 S %=$$DELETE^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$DELETE^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$DELETE^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 S %=$$DELETE^GMPLAPI2(.RETURN,GMPIFN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPROV not numeric.")
 S %=$$DELETE^GMPLAPI2(.RETURN,GMPIFN,9999999)
 D CHKEQ^XTMUNIT("PROVNFND",$P($G(RETURN(0)),U)," - GMPROV not found.")
...
API2UPD ;
 N RETURN
 S %=$$UPDATE^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$UPDATE^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$UPDATE^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 S %=$$UPDATE^GMPLAPI2(.RETURN,GMPIFN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPROV not numeric.")
 S %=$$UPDATE^GMPLAPI2(.RETURN,GMPIFN,9999999)
 D CHKEQ^XTMUNIT("PROVNFND",$P($G(RETURN(0)),U)," - GMPROV not found.")
 S %=$$UPDATE^GMPLAPI2(.RETURN,GMPIFN,GMPFLD,GMPLUSER,GMPROV)
 Q
 ;
API2DET ;
 N %,RETURN
 S %=$$DETAIL^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$DETAIL^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$DETAIL^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 S %=$$DETAIL^GMPLAPI2(.RETURN,GMPIFN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPROV not numeric.")
 S %=$$DETAIL^GMPLAPI2(.RETURN,GMPIFN,9999999)
 D CHKEQ^XTMUNIT("PROVNFND",$P($G(RETURN(0)),U)," - GMPROV not found.")
...
API2DETX ;
 N RETURN
 S %=$$DETAILX^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$DETAILX^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$DETAILX^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 S %=$$DETAILX^GMPLAPI2(.RETURN,GMPIFN,9)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPMULTI invalid.")
...
API2VFY ;
 N RETURN
 S %=$$VERIFY^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$VERIFY^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$VERIFY^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
API2DLTD ;
 N RETURN
 S %=$$DELETED^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$DELETED^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$DELETED^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
API2VFD ;
 N RETURN
 S %=$$VERIFIED^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$VERIFIED^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$VERIFIED^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
API2ACT1 ;
 N RETURN
 S %=$$ACTIVE^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$ACTIVE^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$ACTIVE^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
API2INCT ;
 N %,RETURN
 S %=$$INACTV^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$INACTV^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$INACTV^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 S %=$$INACTV^GMPLAPI2(.RETURN,GMPIFN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPROV not numeric.")
 S %=$$INACTV^GMPLAPI2(.RETURN,GMPIFN,9999999)
 D CHKEQ^XTMUNIT("PROVNFND",$P($G(RETURN(0)),U)," - GMPROV not found.")
...
API2ONST ;
 N RETURN
 S %=$$ONSET^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$ONSET^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$ONSET^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
API4LSTM ;
 N RETURN
 S %=$$LASTMOD^GMPLAPI4(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 S %=$$LASTMOD^GMPLAPI4(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 S %=$$LASTMOD^GMPLAPI4(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
...
CODESTS
 N %,RETURN
 S %=$$CODESTS^GMPLAPI2(.RETURN)
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - Missing GMPIFN.")
 K RETURN
 S %=$$CODESTS^GMPLAPI2(.RETURN,"A")
 D CHKEQ^XTMUNIT("INVPARAM",$P($G(RETURN(0)),U)," - GMPIFN not numeric.")
 K RETURN
 S %=$$CODESTS^GMPLAPI2(.RETURN,9999999)
 D CHKEQ^XTMUNIT("PRBNFND",$P($G(RETURN(0)),U)," - GMPIFN not found.")
 K RETURN
 S %=$$CODESTS^GMPLAPI2(.RETURN,GMPIFN)
 D CHKEQ^XTMUNIT(1,$G(RETURN),"ICD9 code should be active.")
 Q
 ;
XTENT ;
 ;;API2NEW
