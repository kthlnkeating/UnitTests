...
ADDLIST(RETURN)
 ...
 ;
GETCAT
 S RETURN="^TMP(""GMPLIST"",$J)" K:$D(@RETURN) @RETURN
...
GETCATD
 ...
 D CHKEQ^XTMUNIT(0,RET,"Incorrect return")
 D CHKEQ^XTMUNIT("CTGNFND",$P(@RETURN@("ERR",0),U,1),"CTGNFND expected")
 ;
 S RETURN="^TMP(""GMPLIST"",$J)" K:$D(@RETURN) @RETURN
 S RET=$$GETCATD^GMPLAPI5(.RETURN)
 D CHKEQ^XTMUNIT(0,RET,"Incorrect return.")
 D CHKEQ^XTMUNIT("INVPARAM",$P(@RETURN@("ERR",0),U,1),"INVPARAM expected")
 ; 
 S RETURN="^TMP(""GMPLIST"",$J)" K:$D(@RETURN) @RETURN
